  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'sales', name: 'Sales', component: () => import('../views/sales/SalesView.vue'), meta: { title: '销售管理' } },
        { path: 'inventory', name: 'Inventory', component: () => import('../views/inventory/InventoryView.vue'), meta: { title: '库存管理' } },
